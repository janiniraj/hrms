...
if(!defined('APP_NAME')){define('APP_NAME','HRMS');}
if(!defined('FB_URL')){define('FB_URL', 'https://www.facebook.com/hrms');};
if(!defined('TWITTER_URL')){define('TWITTER_URL', 'https://twitter.com/hrmsapp');};
...
if(!defined('CONTACT_EMAIL')){define('CONTACT_EMAIL','hrms@gamonoid.com');}
if(!defined('KEY_PREFIX')){define('KEY_PREFIX','HRMS');}
...
define('ALL_CLIENT_BASE_PATH', '/var/www/hrms.app/hrmsapp/');

define('LDAP_ENABLED', true);
define('RECRUITMENT_ENABLED', false);
define('APP_WEB_URL', 'https://hrms.com');
